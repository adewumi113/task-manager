<?php
    ...
    $sections = $Section->fetch_sections();

    if($user['user_role_id'] < 5){
        $tasks = $Task->fetch_supervisortasks($userid);
        
    }else{
        $tasks = $Task->fetch_alltasks($userid);
    }
...
<head>
    ...
    <title>TaskMasta - Users Profile</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="dashboard.php" class="logo d-flex align-items-center">
            <img src="assets/images/new-logo.png" alt="TakMasta Logo" width="120" >
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown  z-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            ...
            <li class="notification-item">
            <i class="fa-solid fa-circle-xmark text-danger"></i></i>
                <div>
                    <h4>Lorem Ipsum</h4>
                    <p>Quae dolorem earum veritatis oditseno</p>
                    <p>1 hr. ago</p>
        ...
        <li class="nav-item dropdown pe-3">
            ...
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $user["user_firstname"]?></span>
            </a><!-- End Profile Iamge Icon -->

            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                <li class="dropdown-header">
                    <h6><?php echo $user["user_firstname"] . " " . $user["user_lastname"]?></h6>
                    <span><?php echo $user["job_title_name"]?></span>
                </li>
                <li>
                    <hr class="dropdown-divider">
                </li>
